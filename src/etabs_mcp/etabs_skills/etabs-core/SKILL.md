...
# ⛔ NEVER call InitializeNewModel() — permanently blanks the ETABS viewport UI.
# To start fresh, clear geometry instead:
model.SetModelIsLocked(False)
model.SelectObj.All()
model.FrameObj.Delete("", 2)              # delete all frames
model.AreaObj.Delete("", 2)               # delete all areas
model.PointObj.DeleteSpecialPoint("", 2)  # delete leftover joints
# Then redefine materials, sections, and geometry on the clean canvas.
```
